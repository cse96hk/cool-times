...
## 7일차 : 24-07-14
17. 뉴스타임즈 마무리 & 팀프로젝트 회의 9pm~11pm

#### 과제 : 도전 과제 후 최종 도메인 공유

## 6일차 : 24-07-13
14. 페이지네이션이란
15. 페이지네이션을 직접 만들어보자
16. 페이지네이션을 직접 만들어 보자 2탄
#### 과제 : 16탄 까지지 내용 도메인 공유

## 5일차 : 24-07-12
11. 코드 리펙토링 : 더 나은 코드를 위해
12. 에러는 어떻게 처리할까? : try-catch
13. 에러핸들링: 안보이지만 중요한것

#### 과제 : 13탄 까지 내용 도메인 공유
* 피드백 : 일반함수에서 비동기 함수를 호출하면 await을 항상 써야할까? 적용완료
